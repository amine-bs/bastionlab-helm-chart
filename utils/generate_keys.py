...
data_owner_pub_key = data_owner_key.pubkey.save_pem("pubkeys/data_owner.pem")

data_scientist_key = SigningKey.generate()
data_scientist_key.save_pem("privkeys/data_scientist.key.pem")
data_scientist_pub_key = data_scientist_key.pubkey.save_pem("pubkeys/data_scientist.pem")